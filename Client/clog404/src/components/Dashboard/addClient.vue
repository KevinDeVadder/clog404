<template>
  <div>
    <v-layout row justify-center class="my-2">
        ...
        <v-btn dark raised color="blue darken-2" class="mb-3" v-on="on"><v-icon dark>add</v-icon>Add new client</v-btn>
        </template>
        <v-card>
            <v-card-title>
            ...
            <v-card-actions>
                ...
                <v-btn color="blue darken-1" flat @click="submit">Add client</v-btn>
            </v-card-actions>
        </v-card>
        </v-dialog>
    </v-layout>
